...
export const GitHubIcon = (p: IconProps) => (
  <Base {...p}>
    <path d="M12 2.5a9.5 9.5 0 0 0-3 18.5c.48.09.65-.2.65-.45v-1.7c-2.65.58-3.2-1.16-3.2-1.16-.43-1.1-1.05-1.4-1.05-1.4-.86-.59.06-.58.06-.58.95.07 1.45.98 1.45.98.85 1.45 2.22 1.03 2.76.79.09-.61.33-1.03.6-1.27-2.1-.24-4.3-1.05-4.3-4.66 0-1.03.37-1.87.97-2.53-.1-.24-.42-1.2.09-2.5 0 0 .79-.25 2.6.97a9 9 0 0 1 4.74 0c1.8-1.22 2.59-.97 2.59-.97.51 1.3.19 2.26.1 2.5.61.66.96 1.5.96 2.53 0 3.62-2.2 4.42-4.31 4.65.34.3.65.87.65 1.76v2.6c0 .25.16.55.66.45A9.5 9.5 0 0 0 12 2.5Z" />
  </Base>
);

export const SlidersIcon = (p: IconProps) => (
  <Base {...p}>
    <path d="M4 6h7M4 12h4M4 18h9" />
